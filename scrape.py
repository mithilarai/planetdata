...
browser = webdriver.Chrome("C:/Users/sylvi/OneDrive/Desktop/class127new/chromedriver.exe")
...
def scrape():
    ...
    for i in range(1,204):
        ...
        browser.find_element("path", '//*[@id="primary_column"]/div[1]/div[2]/div[1]/div/nav/span[2]/a').click()
